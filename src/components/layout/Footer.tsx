      ...
      <Container className="relative z-10">
          ...
          <div className="space-y-8">
            ...
            <ul className="flex flex-col gap-4">
              {[
                ...
                <li key={service.name}>
                  <Link to={service.href} className="text-sm text-white/40 hover:text-brand-orange transition-colors">
                    {service.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
          ...
          <div className="flex gap-8">
            ...
            <Link to="/privacy" className="text-xs text-white/20 font-bold uppercase tracking-widest hover:text-brand-orange transition-colors">Privacy Policy</Link>
          </div>
        </div>
      </Container>
    </footer>
