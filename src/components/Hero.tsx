...
const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-brand-dark">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10 py-20 lg:py-0">
        {/* Left Content */}
        <motion.div
        ...
        >
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-brand-primary/20 bg-brand-primary/5 text-brand-primary text-[10px] font-bold uppercase tracking-[0.2em] w-fit">
              <Sparkles className="w-3 h-3" />
              Growth System Architects
            </div>
            
            <div className="space-y-6">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1] text-brand-text-heading font-display">
                Architecting <br />
                <span className="text-brand-primary">Digital Revenue.</span>
              </h1>
              
              <p className="text-lg md:text-xl text-brand-text-secondary max-w-xl font-normal leading-[1.6] font-sans">
