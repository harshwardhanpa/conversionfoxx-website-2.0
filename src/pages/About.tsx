    ...
    <Layout>
      <div className="relative z-10 pt-20">
          ...
          <Container>
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.1] text-brand-text-heading max-w-4xl mx-auto">
                ...
                Scale <span className="text-orange-500">Revenue Predictably</span>
              </h1>
          ...
          <Container>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                className="space-y-6"
              >
                <span className="text-orange-500 text-sm font-sans font-bold uppercase tracking-[0.2em]">Our Story</span>
                <h2 className="text-3xl md:text-4xl font-semibold text-brand-text-heading">Bridging the Gap Between <br />Traffic and Revenue</h2>
              ...
              >
                <Card padding="xl" className="aspect-square flex items-center justify-center relative overflow-hidden group">
                  ...
                  <div className="relative z-10 text-center space-y-6">
                    <div className="bg-orange-500/10 p-4 rounded-xl text-orange-500 inline-flex items-center justify-center mb-4">
                      <Rocket className="w-10 h-10" />
                    </div>
                    <h3 className="text-xl md:text-2xl font-semibold italic text-brand-text-heading leading-relaxed">"Growth is not an accident; it's a system."</h3>
        ...
        <Section id="mission-vision">
          <Container>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-semibold text-brand-text-heading max-w-2xl mx-auto">What Drives Us</h2>
            </div>
        ...
        <Section id="why-choose-us" background="subtle">
          <Container>
            <div className="text-center mb-16 space-y-4">
              <span className="text-orange-500 text-sm font-sans font-bold uppercase tracking-[0.2em]">Why ConversionFoxx?</span>
              <h2 className="text-3xl md:text-4xl font-semibold text-brand-text-heading max-w-2xl mx-auto">Why Businesses Choose Us</h2>
            </div>
              ...
              {[
                ...
                >
                  <Card padding="lg" className="h-full">
                    <div className="bg-orange-500/10 p-3 rounded-xl text-orange-500 inline-flex items-center justify-center mb-6 group-hover:bg-orange-500 group-hover:text-white transition-all duration-300">
        ...
        <Section id="expertise">
          <Container>
            <div className="text-center mb-16 space-y-4">
              <span className="text-orange-500 text-sm font-sans font-bold uppercase tracking-[0.2em]">Our Expertise</span>
              <h2 className="text-3xl md:text-4xl font-semibold text-brand-text-heading max-w-2xl mx-auto">Built to Support Modern Growth</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-orange-500/5 border-2 border-dashed border-orange-500/20 p-8 rounded-2xl flex flex-col justify-center items-center text-center gap-6 group hover:border-orange-500/50 transition-colors duration-300">
                <h3 className="text-xl md:text-2xl font-semibold text-brand-text-heading">Need a Custom Solution?</h3>
                <Button to="/contact" className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-xl font-medium transition">
                  Let's Talk
                </Button>
              </div>
            </div>
          ...
          <Container>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                className="space-y-6"
              >
                <h2 className="text-3xl md:text-4xl font-semibold text-brand-text-heading max-w-2xl">We Focus on Results <br /><span className="text-orange-500">That Scale</span></h2>
                <p className="text-gray-400 font-sans text-base md:text-lg max-w-xl leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                  {[
                    ...
                    <div key={item} className="flex items-center gap-3 group">
                      <div className="w-5 h-5 rounded-full bg-orange-500/20 flex items-center justify-center group-hover:bg-orange-500 transition-colors">
                        <div className="w-1.5 h-1.5 rounded-full bg-orange-500 group-hover:bg-white" />
                      </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-6 pt-12">
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center space-y-2 hover:border-orange-500/30 transition-all duration-300">
                    <div className="text-4xl font-bold text-orange-500">300%</div>
                    <div className="text-[10px] font-sans text-gray-400 font-bold uppercase tracking-[0.2em]">ROI Increase</div>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center space-y-2 hover:border-orange-500/30 transition-all duration-300">
                    <div className="text-4xl font-bold text-orange-500">5X</div>
                    <div className="text-[10px] font-sans text-gray-400 font-bold uppercase tracking-[0.2em]">Lead Gen</div>
                  </div>
                </div>
                <div className="space-y-6">
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center space-y-2 hover:border-orange-500/30 transition-all duration-300">
                    <div className="text-4xl font-bold text-orange-500">24/7</div>
                    <div className="text-[10px] font-sans text-gray-400 font-bold uppercase tracking-[0.2em]">Monitoring</div>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center space-y-2 hover:border-orange-500/30 transition-all duration-300">
                    <div className="text-4xl font-bold text-orange-500">100%</div>
                    <div className="text-[10px] font-sans text-gray-400 font-bold uppercase tracking-[0.2em]">Commitment</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Section id="team">
          <Container>
            <div className="text-center mb-16 space-y-4">
              <span className="text-orange-500 text-sm font-sans font-bold uppercase tracking-[0.2em]">Our Team</span>
              <h2 className="text-3xl md:text-4xl font-semibold text-brand-text-heading max-w-2xl mx-auto">The People Behind ConversionFoxx</h2>
              <p className="text-gray-400 font-sans max-w-xl mx-auto text-base md:text-lg leading-relaxed">
              ...
              {[
                ...
                >
                  <Card padding="lg" className="h-full text-center">
                    <div className="w-20 h-20 bg-orange-500/10 rounded-full mx-auto mb-6 flex items-center justify-center font-bold text-2xl text-orange-500 group-hover:scale-110 transition-transform">
                      {member.name.charAt(0)}
                    </div>
                    <h3 className="text-xl font-semibold mb-2 text-brand-text-heading">{member.name}</h3>
                    <div className="text-orange-500 text-[10px] font-sans font-bold uppercase tracking-[0.2em] mb-4">{member.role}</div>
        ...
        <Section id="process" background="subtle">
          <Container>
            <div className="text-center mb-16 space-y-4">
              <span className="text-orange-500 text-sm font-sans font-bold uppercase tracking-[0.2em]">How We Work</span>
              <h2 className="text-3xl md:text-4xl font-semibold text-brand-text-heading max-w-2xl mx-auto">Our Process</h2>
            </div>
                ...
                >
                  <Card padding="lg" className="h-full text-center group">
                    <div className="relative z-10 space-y-6">
                      <div className="bg-orange-500/10 p-3 rounded-xl text-orange-500 inline-flex items-center justify-center mb-4 group-hover:bg-orange-500 group-hover:text-white transition-colors duration-300">
                        <step.icon className="w-8 h-8" />
                      </div>
                      <h3 className="text-xl font-semibold text-brand-text-heading">{step.title}</h3>
          ...
          <Container>
            ...
            >
              <Card padding="xl" className="text-center space-y-8 relative overflow-hidden" hoverEffect={false}>
                <div className="absolute top-0 left-0 w-64 h-64 bg-orange-500/5 blur-[100px] rounded-full pointer-events-none" />
                <div className="relative z-10 space-y-6">
                  <h2 className="text-3xl md:text-4xl font-semibold text-brand-text-heading max-w-2xl mx-auto">Want to See What We Can Build?</h2>
                  ...
                  <Button to="/services" className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-xl font-medium transition inline-flex items-center gap-2">
                    View Services
              ...
              <Card padding="xl" className="text-center space-y-10 relative overflow-hidden border-orange-500/20 shadow-2xl shadow-orange-500/5" hoverEffect={false}>
                ...
                <div className="relative z-10 space-y-8">
                  <h2 className="text-5xl md:text-6xl font-bold leading-[1.1] text-brand-text-heading max-w-4xl mx-auto">
                    Let’s Build a <br />
                    <span className="text-orange-500">Revenue System</span>
                  </h2>
                  <p className="text-gray-400 font-sans text-base md:text-lg max-w-xl mx-auto leading-relaxed">
